...
import { ErrorInfo, NextApiRequestWithSession, SalesOfferPackageInfo, WithErrors } from '../../interfaces';
...
export default (req: NextApiRequestWithSession, res: NextApiResponse): void => {
    ...
    try {
        ...
        if (errors.length > 0) {
            (salesOfferPackageInfo as WithErrors<SalesOfferPackageInfo>).errors = errors;
