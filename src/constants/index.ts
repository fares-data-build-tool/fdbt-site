...
export const ID_TOKEN_ATTRIBUTE = 'fdbt-id-token';

export const REFRESH_TOKEN_ATTRIBUTE = 'fdbt-refresh-token';

export const DISABLE_AUTH_ATTRIBUTE = 'fdbt-disable-auth';
...
export const noRequestError = 'Could not retrieve the request from the context';
